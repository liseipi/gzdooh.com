    ...
    <table width="766" border="0" cellpadding="0" cellspacing="0" align="center">
      <tbody><tr>
        ...
        <td width="425" height="337" alt="" valign="top" style="padding-top:29px; padding-bottom:15px ">
          <div>
            <div style="text-align:center; margin:5px 10px; font-weight:bold;">{{newsData1[id].title}}</div>
            <div style="height:2px; background-color:#C9C9C9 "><img src="images/spacer.gif" width="1" height="1"></div>
            <div style="margin:10px; line-height:18px;" v-html="newsData1[id].content"></div>
