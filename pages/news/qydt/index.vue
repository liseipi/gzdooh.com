    ...
    <table width="766" border="0" cellpadding="0" cellspacing="0" align="center">
      <tbody><tr>
        ...
        <td width="425" height="337" alt="" valign="top" style="padding-top:29px; padding-bottom:15px ">
          <div>
            <div class="r_title" style="height:18px;"><span style="float:left;">企业动态</span><span style="float:right;"><a href="news_more.asp?c=2" class="orange"><strong>more</strong></a></span></div>

            <div style="height:2px; background-color:#C9C9C9 "><img src="@/assets/images/spacer.gif" width="1" height="1"></div>
            <div style="margin:10px 0px;">
              <div v-for="(news, index) in newsData1" style="line-height:22px;">
...
export default {
  ...
  data: () => {
    return {
      newsData1: require('~/assets/data/news1.json'),
    }
  }
}
</script>
